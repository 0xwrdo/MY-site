// ========== LENIS SMOOTH SCROLL ========== //
// Tuned for responsiveness: short duration + custom easing instead of a
// high-lerp "floaty" feel, so it reacts to input quickly.
let lenis;
if (typeof Lenis !== 'undefined' && !window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    ...
    // Thin progress bar across the top, tied to real scroll position
